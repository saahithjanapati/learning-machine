# previous-years-finals-05-10715_CMU_Fall_2021_final_nosoln

Source: `materials/archive/advanced-machine-learning-10-715-cmu/piazza-resources/previous-years-finals-05-10715_CMU_Fall_2021_final_nosoln.pdf`
Duplicate equivalents: `previous-years-finals-05-10715_CMU_Fall_2021_final_nosoln.pdf`
...
### Visual Description
The page contains the exam title, fields for the student's name and ID, a list of instructions and encouraging remarks, and a table titled "Distribution of Marks" showing 9 questions with their respective point values totaling 65.
...
### Visual Description
The page contains text describing a decision tree problem and a pseudocode block for Algorithm 1 (ID3). There are two sub-questions (a) and (b) and a footnote explaining the algorithm's handling of real-valued features.
...
### Visual Description
Text-heavy page containing mathematical definitions for an algorithm and regret, followed by a problem description and its solution in blue text. The bottom section introduces a new problem titled "8) Fairness [7 points]" with bulleted points.
...
### Visual Description
Text-heavy page continuing the "Fairness" problem. It includes bullet points, a narrative description of a bias investigation, and a data table comparing interview rates for two groups across four companies.
...
### Visual Description
Text-only slide. The top half contains the solution to the previous problem in blue text, explaining Simpson's Paradox. The bottom half introduces section "9) Wary of prediction $\neq$ causation [3 points]" with a narrative about a research experiment.
...
### Visual Description
Text-only slide. It concludes the problem from the previous page, highlighting an underlined sentence and asking for its flaw. The solution is provided in blue text at the bottom.
