...
| `bias-correction-in-adam` | 1 | 2026-04-18T20:22:11-04:00 | `doubt`=1 | `addressed`=1 |
...
| `projected-gradient-descent` | 1 | 2026-04-18T14:46:03-04:00 | `doubt`=1 | `addressed`=1 |
...
| `subgradient-method-rate-quantity` | 1 | 2026-04-18T21:15:58-04:00 | `doubt`=1 | `open`=1 |
| `symmetric-cross-terms` | 1 | 2026-04-18T16:46:37-04:00 | `doubt`=1 | `addressed`=1 |
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `dual-function-as-lower-envelope`, `pointwise-infimum-over-x`, `order-of-min-and-max`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `dual-function-infimum-vs-supremum`, `lower-envelope-of-affine-functions`
...
- Event type: `doubt`
- Review state: `open`
- Concepts: `subgradient-method-rate-quantity`, `objective-gap-vs-iterate`
...
- Event type: `incorrect-answer`
- Review state: `addressed`
- Concepts: `whitening-second-moment-identity`, `variance-after-whitening`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `adamw-review-needed`, `decoupled-weight-decay`
...
- Event type: `incorrect-answer`
- Review state: `addressed`
- Concepts: `stationarity-not-sufficient`, `kkt-condition-completeness`
...
- Event type: `incorrect-answer`
- Review state: `addressed`
- Concepts: `dual-function-infimum-vs-supremum`, `lp-duality-precision`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `adamw-update-rule`, `decoupled-weight-decay`, `first-vs-second-moment`, `bias-correction-in-adam`
...
- Event type: `incorrect-answer`
- Review state: `addressed`
- Concepts: `whitening-vs-independence`, `uncorrelated-vs-independent`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `adamw-vs-l2`, `decoupled-weight-decay`, `adaptive-weight-decay-distinction`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `symmetric-cross-terms`, `quadratic-form-expansion`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `basis-vector-entry-selection`, `quadratic-form-expansion`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `unit-norm-constraint`, `squared-norm-lagrangian`, `variance-after-whitening`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `gradient-linearization`, `taylor-expansion-of-gradient`, `hessian-as-jacobian-of-gradient`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `sdp-feasibility`, `sos-gram-matrix`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `matrix-square-root-trick`, `psd-inner-product`
...
- Event type: `proof-gap`
- Review state: `addressed`
- Concepts: `soft-thresholding-case-split`, `prox-piecewise-logic`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `preconditioning-intuition`, `adamw-decoupling`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `strong-convexity-parameter`, `alpha-vs-beta`
...
- Event type: `proof-gap`
- Review state: `addressed`
- Concepts: `mini-batch-unbiasedness`, `discrete-expectation-over-indices`
...
- Event type: `proof-gap`
- Review state: `addressed`
- Concepts: `conditional-expectation`, `fixed-vector-in-expectation`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `indicator-function`, `projected-gradient-descent`
...
- Event type: `doubt`
- Review state: `addressed`
- Concepts: `gradient-mapping`, `prox-update-geometry`
