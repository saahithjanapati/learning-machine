# Class Topic: Probabilistic Graphical Models

Root path: `topics/probabilistic-graphical-models`

## Goal

Catch up from near-zero to practical fluency in representing, inferring, approximating, and learning probabilistic graphical models plus adjacent generative-model ideas covered in class.

## Recommended Order

1. `foundations-probability`
2. `directed-graphical-models`
3. `undirected-graphical-models`
4. `inference-and-belief-propagation`
5. `gnns-and-pgms`
6. `mcmc`
7. `variational-inference-and-em`
8. `generative-adversarial-networks`
9. `score-matching-and-energy-based-models`
10. `course-catchup`
